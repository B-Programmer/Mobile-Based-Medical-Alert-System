    ...
    <td align="center" class="hh"><table width="100%" border="0">
      <tr>
         <td width="80%" bgcolor="#0099CC"><table width="100%" height="466" border="0" bgcolor = "#FFFFFF">
          <tr>
            <th height="48" align="left" valign="top" scope="col"><img src="Images/View Feedback.png" width="178" height="46" alt="View Feedback" /></th>
          </tr>
          <tr>
            <td height="28"><blockquote>
              <p><span class="style2">*The List of all  Users Feedbacks</span><br />
              </p>
              </blockquote>
             </td></tr>
          <tr>
          	<td align="center" valign="top">   <blockquote>
          	  <p class="style5"><span class="ww">
          	    <?php
		  			$Qry1 = "SELECT UserID, UserName, Feedback, FeedbackDate from tblUserFeedback";
					$Result = mysql_query($Qry1);
				   if (mysql_num_rows($Result) <= 0){
				     echo "There are no users' feedback information available in the Database <br> <strong> No Users' Feedback Available </strong>";
					 goto exit1;					 					 
					 } 	
					 echo "<table border = '1' >";
					 echo "<tr class = 'style6'><td align='center' valign='top'>User ID</td><td align='center' valign='top'>User Name</td><td align='center' valign='top'>Feedback</td><td align='center' valign='top'>FeedbackDate</td></tr>\n";
					while($myrow = mysql_fetch_array($Result))
					{
						extract($myrow);
						echo "<tr><td>$UserID</td><td>$UserName</td><td>$Feedback</td><td>$FeedbackDate</td></tr>\n";
					}
				    echo "</table>"; 					    
