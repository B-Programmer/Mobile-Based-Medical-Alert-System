    ...
    <td align="center" class="hh"><table width="100%" border="0">
      <tr>
         <td width="80%" bgcolor="#0099CC"><table width="100%" height="466" border="0" bgcolor = "#FFFFFF">
          <tr>
            <th height="48" align="left" valign="top" scope="col"><img src="Images/View doctor.png" width="178" height="46" alt="View doctor" /></th>
          </tr>
          <tr>
            <td height="28"><blockquote>
              <p><span class="style2">*The List of all Registered Doctors </span><br />
              </p>
              </blockquote>
             </td></tr>
          <tr>
          	  ...
          	  <p class="style5"><span class="ww">
          	    <?php
				   ...
				   if (mysql_num_rows($Result) <= 0){
				     echo "There is no Doctor available in the Database <br> <strong> No Doctors Available </strong>";
					 goto exit1;					 					 
					 } 	
					 echo "<table border = '1' >";
					 echo "<tr class = 'style6'><td align='center' valign='top'>Doctor ID</td><td align='center' valign='top'>Doctor Name</td><td align='center' valign='top'>Address</td><td align='center' valign='top'>Sex</td><td align='center' valign='top'>Email Address</td><td align='center' valign='top'>Phone No </td><td align='center' valign='top'>Age</td><td align='center' valign='top'>Specialization</td></tr>\n";
					while($myrow = mysql_fetch_array($Result))
					{
						extract($myrow);
						echo "<tr><td>$DoctorID</td><td>$DoctorName</td><td>$Address</td><td>$Sex</td><td>$EmailAddress</td><td>$PhoneNo</td><td>$Age</td><td>$Specialization</td></tr>\n";
					}
				    echo "</table>"; 		
